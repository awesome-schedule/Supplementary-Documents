...
\usepackage{float}
\newcommand\ytl[2]{
\parbox[b]{15em}{\hfill{\color{cyan}\bfseries\sffamily #1}~
...
\begin{table}[H]
    ...
    \ytl{04/05/2019}{Presentation During CS 2110 Class. Get Endorsed by Professor Basit}
    \ytl{04/09/2019}{Cooperation with CSSS}
    \ytl{04/14/2019}{Cooperation with MSN}
    \ytl{Before 05/2019}{Cooperation with Orientation Leaders}
    \ytl{05/2019}{Create Serv List}
